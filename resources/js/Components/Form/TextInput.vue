	...
	<div class="block">
		...
		<div class="relative block">
			...
			<input ref="input" :class="[
				...
				'bg-white border border-neutral-200 focus:border-burgundy',
				placeholderClasses,
				'text-[0.75rem] leading-[0.938rem] font-normal',
				'disabled:opacity-50',
				{ 'pl-7': $slots.iconLeft },
				{ 'pr-7': $slots.iconRight },
			]" v-bind="$attrs" :type="type" :value="modelValue"
				@input="$emit('update:modelValue', $event.target.value)" @focus="$emit('focused')">
