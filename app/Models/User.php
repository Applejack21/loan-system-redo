...
class User extends Authenticatable
{
	...
	/**
	 * Returns a list of ratings created by this user.
	 */
	public function createdRatings(): HasMany
	{
		return $this->hasMany(Rating::class, 'created_by_user_id', 'id');
	}

	/**
	 * Returns a list of ratings updated by this user.
	 */
	public function updatedRatings(): HasMany
	{
		return $this->hasMany(Rating::class, 'last_updated_by_user_id', 'id');
	}
